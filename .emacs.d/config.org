...
#+begin_src emacs-lisp
    ...
    ;; Exclude problematic modes from desktop save
    (setq desktop-modes-not-to-save
        '(dired-mode doc-view-mode info-mode fundamental-mode))
...
(defface my-modeline-background
  '((t :background "#B33500" :foreground "white" :inherit bold))
